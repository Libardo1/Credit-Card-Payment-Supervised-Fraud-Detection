...
merch2 = lagcum(daily_merch,21)
merch$merchLag21Cum = ifelse(merch2$date>merch2$join_date,merch2$i.cum_merch,merch2$i.cum_merch-merch2$cum_merch)
...
card2 = lagcum(daily_card,21)
card$cardLag21Cum = ifelse(card2$date>card2$join_date,card2$i.cum_card,card2$i.cum_card-card2$cum_card)
