...
data = pd.read_csv("/Users/hzdy1994/Desktop/DSO 562/Project3/all_data.csv", index_col = 0)
...
features_sub = df[['zip_with_merchnum_7', 'zip_with_merchnum_14', 'card_amount_to_median_28', 'cardLag7Cum', 'merchant_amount_to_median_28', 'merchDaily', 'merchnum_per_card_14', 'cardnum_per_merch_28', 'merchLag28Cum', 'card_amount_to_median_14']]
clf = MLPClassifier()
clf.fit(features_sub, labels)
print "accuracy is", clf.score(features_sub, labels)
prediction = clf.predict(features_sub)
...
score_df.to_csv("/Users/hzdy1994/Desktop/Fraud Scores.csv")
